...
if __name__ == '__main__':
    ...
    s1.cmd('./switch > output/switch.log 2>&1 &')
    # s1.cmd('./switch-reference > output/switch.log 2>&1 &')
    ...
    h2.cmd('iperf -s &')
    h3.cmd('iperf -s &')
    h1.cmd('iperf -c 10.0.0.2 -t 30 > output/1.h2.txt &')
    h1.cmd('iperf -c 10.0.0.3 -t 30 > output/1.h3.txt')  # No & to wait for completion
    ...
    h1.cmd('iperf -s &')
    h2.cmd('iperf -c 10.0.0.1 -t 30 > output/2.h2.txt &')
    h3.cmd('iperf -c 10.0.0.1 -t 30 > output/2.h3.txt')  # No & to wait for completion
